		...
		<div>
			<form id="frm" name="frm" method="post" action="login.do">
				<table border="1" style="border-collapse: collapse;">
					<tr>
						<th width="200">아이디</th>
						<td width="200" align="center"><input type="text" id="id" name="id" style="text-align:center; width:95%; border: 0;"></td>
					</tr>
					<tr>
						<th width="200">패스워드</th>
						<td width="200" align="center"><input type="password" id="pwd" name="pwd" style="text-align:center; width:95%; border: 0;"></td>
					</tr>
					<tr>
